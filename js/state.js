...
function applySettings() {
    getSettings((result) => {
        ...
        // Setup base background hex for the alpha math (Fallback to dark for images)
        ...
        // --- ALPHA BLENDING TEXT ENGINE ---
        // Blend the solid Search Color with the Global Background to find the actual perceived color
        const effectiveSearchBg = blendColors(activeSearchBg, globalBgHex, currentSearchOpacityNum);
        
        // Main bar looks at the blended background
        const searchTextColor = getTextColorForBackground(effectiveSearchBg);
        
        // Dropdown menu stays fully opaque, so it looks purely at the solid color
        ...
        // --- ALPHA BLENDING TEXT ENGINE (Shortcuts) ---
